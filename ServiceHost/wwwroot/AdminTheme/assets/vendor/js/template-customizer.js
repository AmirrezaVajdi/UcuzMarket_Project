            ...
            E = function () {
                ...
                return e = t, s = [{
                    ...
                    value: function () {
                        if (!this._ssr) {
                            var t = !!document.querySelector(".layout-navbar"),
                                ...
                                s = (document.querySelector(".layout-menu-horizontal.menu, .layout-menu-horizontal .menu"), !!document.querySelector(".layout-wrapper.layout-navbar-full")),
                    ...
                    value: function (t, e) {
                        ...
                        var ressss = '<link rel="stylesheet" type="text/css" href="' .concat(host, e, '" class="').concat(t, '"/>');
